...
vi.mock('@/store/appStore', () => ({
  useAppStore: vi.fn((sel?: any) => createMockAppStore({
    data: { projects: storeState.data.projects, loading: false, error: null },
    ui: { selectedProjectId: storeState.ui.selectedProjectId, selectedExpertId: null, hoveredProjectId: null, expertImportDialog: null },
  }).useAppStore(sel)),
}));
