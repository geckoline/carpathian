...
const projects = [
  {
    ...
    yearRange: '2024-2028',
    expertIds: [leadExpert.id, linkedExpert.id],
    teamMembers: [
      { id: leadExpert.id, name: leadExpert.name },
      { id: linkedExpert.id, name: linkedExpert.name },
    ],
    lat: 47,
    lng: 25,
    countries: ['RO'],
  ...
  },
  {
    ...
    yearRange: '2025-2029',
    expertIds: [allOnlyExpert.id],
    teamMembers: [{ id: allOnlyExpert.id, name: allOnlyExpert.name }],
    lat: 48,
    lng: 16,
    countries: ['AT'],
