  ...
  const modal = (
    <FocusTrap focusTrapOptions={{ initialFocus, fallbackFocus: '#modal-close-btn' }}>
      ...
      >
        ...
        >
          <header className="sticky top-0 z-10 flex items-center justify-between border-b border-[var(--color-panel-border)] bg-[var(--color-panel-surface)] p-4">
          ...
          {footer && (
            <div className="border-t border-[var(--color-panel-border)] bg-[var(--color-panel-surface)] px-4 py-3">
              {footer}
            </div>
          )}
        </motion.div>
